...
var calendar = {
  ...
  solar2lunar:function (y,m,d) { //参数区间1900.1.31~2100.12.31
    ...
    //根据日干支查找空亡
    var kongwang ="";
    for(var n=0;n<calendar.Gan.length;n++ ){
    	if(calendar.Gan[n]==gzD.substring(0,1)){
    		 for(var m=0;m<calendar.Zhi.length;m++){
    		 	  if(calendar.Zhi[m]==gzD.substring(1,2)){
    		 	  	 if(m+10-(n+1)<10){
    		 	  	 	 kongwang=calendar.Zhi[m+10-(n+1)+1]+""+calendar.Zhi[m+10-(n+1)+2];
    		 	  	 }else{
    		 	  	 	 kongwang=calendar.Zhi[m+10-(n+1)-12+1]+""+calendar.Zhi[m+10-(n+1)-12+2];
    		 	  	 }
    		 	  }
    		 }
    	}
